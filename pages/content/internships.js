      ...
      <div className="flex flex-col md:flex-row lg:flex-row p-4 bg-green-900 items-center justify-center gap-1 md:gap-60 lg:gap-72">
        <div className="flex flex-col p-4 gap-4 items-center my-12 max-w-3xl text-left">
          <h1 className="text-5xl md:text-7xl lg:text-7xl text-white font-bold">
            Internship & Externship <span className="text-yellow-400">Programs</span>
          </h1>
          <p className="text-lg text-white">
          Internship and Externship Programs provide individuals with the chance to gain real-world experience, apply their knowledge in professional settings, and learn from industry experts. Internships typically involve working within an organization, while externships focus on short-term, immersive experiences that allow you to shadow professionals in your field of interest.
          </p>
        </div>
