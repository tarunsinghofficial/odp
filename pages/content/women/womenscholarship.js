      ...
      <div className="flex flex-col md:flex-row lg:flex-row p-4 bg-green-900 items-center justify-center gap-1 md:gap-60 lg:gap-72">
        <div className="flex flex-col p-4 gap-4 items-center my-12 max-w-3xl text-left">
          <h1 className="text-5xl md:text-7xl lg:text-7xl text-white font-bold">
            Women Scholarship <span className="text-yellow-400">Programs</span>
          </h1>
          <p className="text-lg text-white">
          Womens Scholarship Programs for Tech are initiatives designed to provide financial assistance, mentorship, and support specifically for women seeking education and careers in technology-related fields. These programs aim to bridge the gender gap in tech by offering scholarships that encourage women to pursue their academic and professional aspirations.
          </p>
        </div>
...
export default WomenScholarship